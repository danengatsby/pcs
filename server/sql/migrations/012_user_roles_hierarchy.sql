-- Introduce noua ierarhie de roluri si elimina valoarea legacy ADMIN.
-- Mai intai se elimina constrangerile vechi pe role pentru a permite remaparea valorilor.
