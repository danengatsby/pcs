export const adminNavigationGroups = [
  ...
  { key: 'specialized', label: 'Responsabilități', description: 'Trezorerie și activitate parlamentară.' },
...
export const adminNavigation = [
  { key: 'treasury', group: 'specialized', path: 'treasury', label: 'Trezorerie', description: 'Încasări, cheltuieli, documente justificative și confirmări auditate.', capability: 'finance.read', tasks: 'Ciorne care așteaptă verificarea și confirmarea operațiunii.' },
  { key: 'parliamentary', group: 'specialized', path: 'parliamentary', label: 'Grup parlamentar', description: 'Inițiative, responsabili, etape și termene de urmărit.', capability: 'parliamentary.read', tasks: 'Inițiative deschise fără responsabil sau cu termen depășit.' },
  ...
  { key: 'communications', group: 'operations', path: 'communications', label: 'Comunicare', description: 'Comunicări autorizate și verificarea destinatarilor eligibili.', capability: 'communication.preview', tasks: null },
